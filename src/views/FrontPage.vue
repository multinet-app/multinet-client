      ...
      return [
        {
          ...
          text: 'Explore the Paul Revere dataset using an interactive and beautiful MultiLink diagram. Discover the figures coordinating a pivotal event in history!',
        ...
        },
        {
          ...
          text: 'Explore the Les Miserables dataset using an interactive MultiMatrix. See the factions and relationships for yourself!',
        ...
        },
        {
          ...
          text: 'The characters of Les Miserables, laid out in a colorful and interactive MultiLink diagram.',
        ...
        },
        {
          ...
          text: 'See the relationships between Paul Revere and his contemporaries through a MultiMatrix layout.',
